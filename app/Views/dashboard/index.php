<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?= e(app_url('/chat')) ?>" class="btn btn-success">Chat privado</a>
        <a href="<?= e(app_url('/reportes')) ?>" class="btn btn-outline-primary">Reportes</a>
    </div>
</div>
...
<div class="row g-3">
    ...
    <div class="col-md-6 col-xl-4"><div class="card border-0 shadow-sm h-100"><div class="card-body">
        ...
        <a href="<?= e(app_url('/modulo?slug=' . urlencode($module['slug']))) ?>" class="btn btn-outline-primary btn-sm">Abrir módulo</a>
    </div></div></div>
    <?php endforeach; ?>
</div>
...
<div class="card mt-4 border-0 shadow-sm"><div class="card-body">
    ...
    <form method="post" action="<?= e(app_url('/cambiar-clave')) ?>" class="row g-2">
