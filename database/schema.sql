...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('estudiante','padre','docente','administrador','servicios','finanzas') NOT NULL,
...
('Admin General', 'admin@school.local', 'administrador', '$2y$12$NeFQOWWFPgQN9UuFVuqKXO7CsLIe5tB6o3NAlWVsA616QRBgtDF3e')
